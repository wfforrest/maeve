...
#'
#' Data frame with 7 columns and 322 rows with a simulated study of two groups with twelve animals each.  Each animal control animal log-growth pattern follows an underlying concave quadratic, while each treatment animal log-growth follows a convex quadratic superposed with a cosine wave. This simulated set has dropouts. See maeve/inst/scripts/simulate_maeve_test_data.R for details.
#'
...
#' @docType data
#' @keywords datasets
#' @name two_group_sim_with_dropouts
#' @usage data( two_group_sim_with_dropouts )
#' @format A data frame with 7 columns and 322 rows.
#'
NULL
